...
public class TestMain {
    private final String postfilepath = "src/test/Test resources/Tests/Q1Basic/posts.dat";
    private final String commentfilepath = "src/test/Test resources/Tests/Q1Basic/comments.dat";
    private final String expectedfilepath = "src/test/Test resources/Tests/Q1Basic/_expectedQ1.txt";
