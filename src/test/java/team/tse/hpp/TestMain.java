...
public class TestMain {
    private final String postfilepath = "src/test/Test resources/Tests/Q1Case5/posts.dat";
    private final String commentfilepath = "src/test/Test resources/Tests/Q1Case5/comments.dat";
    private final String expectedfilepath = "src/test/Test resources/Tests/Q1Case5/_expectedQ1.txt";
