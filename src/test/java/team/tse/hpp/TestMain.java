...
public class TestMain {
    private final String postfilepath = "src/test/Test resources/Tests/data/posts.dat";
    private final String commentfilepath = "src/test/Test resources/Tests/data/comments.dat";
